...
<main id="achievement" class="page_main">
    <div class="achievement_inner">
        <section id="achievementTitle" class="first_section">
            <div class="works_page_title_wrap">
                ...
                <h1 class="works_page_title_main">
                    ...
                    <span class="page_title_sub">EC事業実績</span>
                </h1>
            </div>
            <div class="works_description">
                <p>
                ハワイの人々と日本のハワイラバーを繋ぐ、応援オンラインセレクトショップ「LaniLani market」の運営をはじめ、<br class="pc">
                編集プロダクション事業やコンテンツ制作事業のリソースや知見を活かしさまざまな商材のECサイトを展開しています。
                </p>
            </div>
            <div class="deco__bg">
        ...
        <section class="archive_list">
            ...
            $media_cat = get_category_by_slug('ec');
