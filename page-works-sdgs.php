        ...
        <section id="achievementTitle" class="first_section">
            <div class="works_page_title_wrap">
                ...
                <h1 class="works_page_title_main">
                    ...
                    <span class="page_title_sub">SDGs推進事業実績</span>
                </h1>
            </div>
            <div class="works_description">
                <p>
                SDGs先進州であるハワイに追随し、日本でもSDGsへの認知を高めていくため、サステナブルについての啓もう活動や、<br class="pc">
                アイドルグループとのコラボレーションによるSDGsアイテムの企画・製作を行っています。
                </p>
            </div>
            <div class="deco__bg">
