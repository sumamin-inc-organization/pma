...
<main id="achievement" class="page_main">
    <div class="achievement_inner">
        <section id="achievementTitle" class="first_section">
            <div class="works_page_title_wrap">
                ...
                <h1 class="works_page_title_main">
                    <span class="page_title_main">CONTENTS</span>
                    <span class="page_title_sub">コンテンツ制作事業実績</span>
                </h1>
            </div>
            <div class="works_description">
                <p>
                    ストックされた最新情報をウェブサイトなど各デバイス用コンテンツにご提供いたします。<br>
                    メディアに限らず、大手ポータルサイトの特集記事や企業オウンドメディアのコンテンツとして、<br>
                    または地図情報アプリなどスマホ用コンテンツとしても提供可能です。
                </p>
            </div>
            <div class="deco__bg">
        ...
        <section class="archive_list">
            ...
            $media_cat = get_category_by_slug('contents');
