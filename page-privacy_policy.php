<?php get_header(); ?>
<main id="privacy_poricy" class="page_main">
    <div class="privacy_poricy_inner page_inner">
        <section id="privacy_poricyTitle" class="first_section">
            <div class="page_title_wrap">
                <div class="page_title">
                    <h1 class="page_title_main">PRIVACY POLICY</h1>
                    <p class="page_title_sub">個人情報保護方針について</p>
                </div>
            </div>
        ...
        <section id="privacy_poricyMain">
            <div class="privacy_poricyMain_inner">
                <div class="privacy_poricyMain_content">
                    <ol class="privacy_poricyMain_content_list">
                        <li class="privacy_poricyMain_content_item">適切な個人情報の収集、利用、提供、預託を行います。 個人情報を本人の意思に反して収集、利用、提供、預託することは、権利の侵害になると共に事業者としての信頼を失うことになります。そのため、個人情報の収集、利用、提供、預託等の管理ルールを明文化し、個人情報の適切な管理を行います。 お客様から個人情報を収集させていただく場合は、収集目的、当社の問合せ窓口等を明示したうえで、必要な範囲の個人情報を収集させていただきます。 法的な要請等によらない限り、お客様の事前承認なく第三者に開示・提供することはありません。また、お客様の個人情報を業務委託先に提供する場合は、守秘契約等によって業務委託先に個人情報保護を義務付けるとともに、業務委託先が適切に個人情報を取り扱うように管理いたします。</li>
                        <li class="privacy_poricyMain_content_item">個人情報の紛失、破壊、改ざん、および漏えい等を防止する対策を行います。 個人情報の紛失、破壊、改ざん、および漏えい等を防止するため、不正アクセス対策、ウイルス対策等の情報セキュリティ対策を行います。</li>
                        <li class="privacy_poricyMain_content_item">法令およびその他の規範を遵守します。 個人情報の取り扱いに関して、個人情報保護法をはじめとする個人情報に関する法令およびその他の規範を遵守するとともに、社内規程に準拠して行動します。また、役員を含む就業者に教育・啓発を実施します。</li>
                        <li class="privacy_poricyMain_content_item">個人情報保護コンプライアンス・プログラムの継続的改善を行います。 個人情報保護に関するコンプライアンス・プログラムを策定し、実施し、維持し、および継続的改善を行います。</li>
                        <li class="privacy_poricyMain_content_item">ご紹介とお問合せについて。 当社は、お客様の個人情報を、あらかじめお客様に明示した収集目的等の範囲で利用します。また、当社は、お客様にご利用いただいた当社のサービス、商品等に関連する情報を、電子メールまたは送付物によりご紹介する場合があります。これらのご紹介を不要とされる場合、後述する電子メールアドレスの問合せ窓口にご連絡いただくことによって、以降のご紹介を行わないようにいたします。お客様の個人情報の照会、訂正、削除につきましては、後述する電子メールアドレスの問合せ窓口に、次の事項をご記入の上、ご本人からご連絡ください。</li>
                    </ol>
                </div>
                <div class="privacy_poricyMain_aside_wrap">
                    <div class="privacy_poricyMain_aside">
                        <h3 class="aside_title">本方針および当社の個人情報の<br>取り扱いに関するお問合せ窓口</h3>
                        <p class="aside_email">電子メール:<a href="mailto:soumu@pma-t.co.jp">soumu@pma-t.co.jp</a></p>
                        <p class="aside_text">上記メールアドレス宛に下記内容を記載して下さい。</p>
                        <ul class="aside_list">
                            <li class="aside_list_item">メールアドレス</li>
                            <li class="aside_list_item">お名前</li>
                            <li class="aside_list_item">ご住所</li>
                            <li class="aside_list_item">ご連絡先電話番号</li>
                            <li class="aside_list_item">ご要請内容</li>
                        </ul>
                    </div>
                </div>
            </div>
