...
<main id="achievement" class="page_main">
    <div class="achievement_inner">
        <section id="achievementTitle" class="first_section">
            <div class="works_page_title_wrap">
                ...
                <h1 class="works_page_title_main">
                    ...
                    <span class="page_title_sub">PR・イベント事業実績</span>
                </h1>
            </div>
            <div class="works_description">
                <p>
                    国内で開催されるハワイ関連イベントやファッションショーイベント等のPRを担当。<br>
                    また、自社で発行しているハワイの観光情報誌「LaniLani」の取材により得たコネクションを活かし、<br>
                    ハワイと日本の架け橋となるイベントの企画・運営実績もございます。
                </p>
            </div>
            <div class="deco__bg">
        ...
        <section class="archive_list">
            ...
            $media_cat = get_category_by_slug('pr');
