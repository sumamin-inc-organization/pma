    ...
    <div class="achievement_inner">
        <section id="achievementTitle" class="first_section">
            ...
            <div class="works_description">
                <p>
                    オシャレでエレガントな姉、リリーと、元気でキュートな妹、エマ。<br>
                    この「二人の姉妹のクローゼット」をコンセプトにしたセレクトショップ「Lilly & Emma」をハワイ・ホノルルに展開しています。<br>
                    防水性・防汚性に優れた世界特許の特殊素材で作ったアイテムが話題を呼び、オリジナルのコラボグッズを数々の企業のノベルティ<br class="pc">としてご活用いただいております。
                </p>
            </div>
            <div class="deco__bg">
        ...
        <section class="archive_list">
            ...
            $media_cat = get_category_by_slug('apparel');
